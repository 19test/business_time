...
=== open up your console
    ...
    now = Time.
        parse("2017-06-22 22:38") # => 22.06.2017 23:38 (perşembe)

    1.business_hour.from_now      # => 23.06.2017 09:30 (cuma)
    4.business_hours.from_now     # => 23.06.2017 12:30
    8.business_hours.from_now     # => 23.06.2017 16:30
    10.business_hours.from_now    # => 26.06.2017 09:30 (pazartesi)

    1.business_hour.ago           # => 22.06.2017 16:30 (perşembe)
    4.business_hours.ago          # => 22.06.2017 13:30
    8.business_hours.ago          # => 22.06.2017 09:30

    1.business_day.from_now       # => 26.06.2017 08:30 (pazartesi)
    4.business_days.from_now      # => 29.06.2017 08:30
    8.business_days.from_now      # => 05.07.2017 08:30

    1.business_day.ago            # => 21.06.2017 23:38 (çarşamba)
    4.business_days.ago           # => 16.06.2017 23:38 (cuma)
    8.business_days.ago           # => 12.06.2017 23:38 (pazartesi)

    Date.today.workday?                 # => true  (perşembe)
    Date.parse("2017-06-24").workday?   # => false (cumartesi)

And we can do it from any Date or Time object.

    now = Date.parse("2017-06-22")
    now = Time.parse("2017-06-22 22:38")

    1.business_days.after(now)          # => 26.06.2017 08:30 (pazartesi)
    1.business_days.before(now)         # => 21.06.2017 08:30 (pazartesi)

and we can add holidays that don't count as business days. Örneğin ramazan
bayramı (25-27.06.2017),

    BusinessTime::Config.holidays << Date.parse("2017-06-25")
    BusinessTime::Config.holidays << Date.parse("2017-06-26")
    BusinessTime::Config.holidays << Date.parse("2017-06-27")

    friday_afternoon = Time.parse("2016-06-23 23:00")
